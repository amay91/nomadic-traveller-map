...
**Status:** **Done and in active use.** `app/` is the real, running app. 29/29 automated tests pass. Size: 70.7 KB of an 80 KB code-excluding-comments budget (§4.1). **Live at https://amay91.github.io/nomadic-traveller-map/ since 2026-09-15** (`plan.md` §6, `tasks.md` Phase 3). Phase 3 is complete apart from D5, an optional custom domain.
...
| `logic.js` | 16.0 KB | 8.1 KB | 7.9 KB |
| `app.js` | 68.4 KB | 33.8 KB | 34.5 KB |
| **Total** | **127.2 KB** | **56.5 KB** | **70.7 KB of 80 KB — 9.3 KB headroom** |
