...
**Status:** **Done and in active use.** `app/` is the real, running app. 26/26 automated tests pass. Size: 67.4 KB of an 80 KB code-excluding-comments budget (§4.1). **Live at https://amay91.github.io/nomadic-traveller-map/ since 2026-09-15** (`plan.md` §6, `tasks.md` Phase 3). Phase 3 is complete apart from D5, an optional custom domain.
...
|---|---|---|---|
| `index.html` | 10.3 KB | 2.3 KB | 8.0 KB |
| `styles.css` | 30.3 KB | 10.8 KB | 19.5 KB |
| `logic.js` | 13.8 KB | 6.6 KB | 7.2 KB |
| `app.js` | 63.0 KB | 30.3 KB | 32.7 KB |
| **Total** | **117.3 KB** | **49.9 KB** | **67.4 KB of 80 KB — 12.6 KB headroom** |
